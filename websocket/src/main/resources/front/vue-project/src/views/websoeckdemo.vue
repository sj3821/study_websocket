                ...
                <div class="col-md-6">
                    <form class="form-inline">
                        <div class="form-group">
                            ...
                            <input type="text" id="name" class="form-control" v-model="send_message"
    ...
    methods: {
        send() {
            ...
            if (this.stompClient && this.stompClient.connected) {
                ...
                this.stompClient.send("/app/user", JSON.stringify(msg), {});
            }
        },
        connect() {
            ...
            this.stompClient.connect(
                ...
                frame => {
                    this.connected = true;
                    console.log(frame);
                    this.stompClient.subscribe("/topic/user", tick => {
                        console.log(tick);
